...
A estratégia é:
1) geocodificar os cnes de todos os hospitais de notificação do ano de 2022-2023 de SRAG
...
df_geocodHERE <- df_aud %>% select(cnes,endereco,lat,long) %>% as.data.frame()
```

API_KEY_HERE = satAmDy2WRSF25bYxXicCaM8olNeM8GB5YA15wAwAUM
